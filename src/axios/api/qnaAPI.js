...
export const qnaApi = {
  ...
  //게시글 즐겨찾기 추가
  postBookmarkList: id => instance.post(`/qna/${id}/bookmark`),
  //게시글 즐겨찾기 삭제
  deleteBookmarkList: id => instance.delete(`/qna/${id}/bookmark`),
  //댓글 조회
  ...
  //댓글 수정
  editCommentList: data => instance.edit(`/qna/comment/${data.id}`, data),
  //댓글 추천
  likeCommentList: id => instance.post(`/qna/${id}/like`),
  //댓글 채택
  choiceCommentList: id => instance.post(`/qna/comments/${id}/choice`),
};
